...
module.exports.userSignUp = async (req, res) => {
    ...
    const emailBody = `Please click on the link below to verify your email address: ${process.env.FRONTEND_BASE_URL}/email-verification?id=${newUser._id}&token=${token}`;
